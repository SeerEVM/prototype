...
func opByte(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	th, _ := scope.Stack.pop()
	val, _ := scope.Stack.peek()
	val.Byte(&th)
	return nil, nil
}
